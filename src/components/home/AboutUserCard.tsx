        ...
        <div className="bg-secondary dark:bg-background-9 rounded-xl p-5 sm:p-8">
          <div className="mb-[46px] flex items-center gap-4">
            <figure className="relative inline-block size-14 overflow-hidden rounded-full bg-linear-[135deg,#ffffff_0%,#a585ff_100%] ring-4 ring-white">
              <Image src={Hero7} alt="avatar" className="max-w-full" />
            </figure>
            <div>
              <h5 className="text-accent max-sm:text-heading-6">Global Workforce Management</h5>

              <p className="text-accent/60 max-sm:text-tagline-2">EOR & Payroll Services</p>
            </div>
          </div>
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              ...
              <p className="text-accent/60 text-tagline-2 font-medium">Employment Contracts</p>
            </div>
            <div className="flex items-center gap-2.5">
              ...
              <p className="text-accent/60 text-tagline-2 font-medium">Payroll & Compliance</p>
            </div>
          </div>
        </div>
        <div className="mx-auto max-w-[375px] py-8 text-center max-lg:px-6 max-lg:py-6 max-lg:text-left">
          <h5 className="max-lg:text-heading-6 mb-2">Global EOR & Payroll Management</h5>
          <p className="max-lg:text-tagline-2 px-1 sm:px-0">
            Hire and manage employees in India seamlessly while Worksbot Talent handles contracts, payroll, taxes, and compliance.
          </p>
        </div>
      </div>
    </RevealAnimation>
