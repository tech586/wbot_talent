...
import avatar1 from '@public/images/avatars/avatar1.avif';
import avatar2 from '@public/images/avatars/avatar2.avif';
import avatar3 from '@public/images/avatars/avatar3.jpeg';
import avatar4 from '@public/images/avatars/avatar4.jpeg';
import avatar5 from '@public/images/avatars/avatar5.jpg';
import avatar6 from '@public/images/avatars/avatar6.jpeg';
    ...
    <RevealAnimation delay={0.4}>
      <div className="dark:bg-background-5 col-span-6 rounded-[20px] bg-white max-md:col-span-12">
        <div className="bg-secondary dark:bg-background-9 flex items-center rounded-[12px] p-5 sm:p-8">
          <div className="flex flex-2/3 flex-col gap-4">
            <div className="flex -space-x-2">
              ...
              <div className="ring-secondary text-accent bg-green-800 text-tagline-3 inline-flex size-9 shrink-0 items-center justify-center rounded-full font-medium ring-4">
                500+
              </div>
            </div>

            <p className="text-accent font-medium">
              Access Top Tech Talent Worldwide <br className="hidden sm:block" />
            </p>
          </div>
        ...
        <div className="mx-auto max-w-[375px] py-8 text-center max-lg:px-6 max-lg:py-6 max-lg:text-left">
          <h5 className="max-lg:text-heading-6 mb-2">Hire Skilled Tech Talent</h5>
          <p className="max-lg:text-tagline-2">
            Access a global pool of experienced developers, engineers, and technology professionals to build and scale high-performing teams quickly.
          </p>
        </div>
      </div>
    </RevealAnimation>
