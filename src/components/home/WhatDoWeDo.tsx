    ...
    <section className="bg-background-3 dark:bg-background-6 relative pt-20 pb-14 max-sm:pt-10 max-sm:pb-10 md:pt-[100px] md:pb-16 lg:pt-[160px] lg:pb-[88px] xl:pt-[200px] xl:pb-[100px]">
      <div className="main-container flex flex-col gap-[70px]">
        <div className="flex flex-col items-center gap-y-4 text-center">
          <h1 className="mx-auto max-w-[750px] max-sm:max-w-[320px]">What do <span className='text-red-500'>we do</span></h1>
          <RevealAnimation delay={0.1}>
            <h2 className="mx-auto max-w-[750px] max-sm:max-w-[320px]">
              Worksbot Talent Connects companies with high quality technology talent
            </h2>
          </RevealAnimation>
          <RevealAnimation delay={0.2}>
            <p className="max-w-[850px] max-sm:max-w-[300px]">
            Worksbot Talent connects companies with high-quality technology talent while managing the complexities of employment, payroll, and compliance.
            Our goal is to help companies build and manage distributed teams efficiently without operational complexity.
            </p>
          </RevealAnimation>
        </div>
