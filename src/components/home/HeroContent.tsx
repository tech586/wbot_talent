  ...
  return (
    <div className="main-container z-10 flex flex-col items-start text-left">
      ...
      <RevealAnimation delay={0.2}>
        <h1 className="max-[426px]:text-heading-5 max-sm:text-heading-4 mb-4 font-medium max-[426px]:mb-2.5 max-sm:max-w-[450px] text-black">
      ...
      <ul className="mb-7 flex flex-col gap-4 max-md:w-full md:mb-14 md:flex-row">
        ...
        <RevealAnimation delay={0.5} direction="left" offset={50}>
          <li>
            <LinkButton
              href="/signup"
              className="rounded-sm btn btn-white btn-lg sm:btn-xl dark:btn-transparent hover:btn-secondary dark:hover:btn-accent w-full max-md:mx-auto md:w-auto cursor-pointer">
              Book a Consultation
            </LinkButton>
          </li>
        </RevealAnimation>
